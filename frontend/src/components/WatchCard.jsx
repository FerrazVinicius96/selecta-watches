...
export default function WatchCard({ watch, index, onSelect }) {
  ...
  return (
    <article className="wcard" style={{ '--reveal-delay': `${index * 90}ms` }}>
      ...
      <div className="wcard__body">
        ...
        {watch.description && <p className="wcard__desc">{watch.description}</p>}

        <div className="wcard__foot">
          <span className="wcard__price">{formatPrice(watch.price)}</span>
          <button
            type="button"
